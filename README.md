...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-718a45dd9cf7e7f842a935f5ebbe5719a5e09af4491e668f4dbf3b35d5cca122.svg)](https://classroom.github.com/online_ide?assignment_repo_id=10872783&assignment_repo_type=AssignmentRepo)
# Seleção Bitlab 2023
...
1- Instalar a extensão Live Server no VSCode e clicar com o botão direito em cima do arquivo index.html e clicar em "Open with live server" - Link para a extesão: https://github.com/ritwickdey/vscode-live-server-plus-plus

2- Após abrir o site no seu navegador, insira a palavra e/ou a frase e clique no botão verificar que o programa vai verificar se contem ou não conteúdo imprórprio.

3- Após verficar a existencia desse conteúdo, aparecera na tela uma mensagem de report podendo dizer: "Conteudo Aprovado!", "Conteúdo impróprio detectado: (conteúdo)" e "Conteúdo impróprio detectado: (conteúdo) é um Tópico Sensível".
